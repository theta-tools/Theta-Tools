...
A simple & sober Login Form.
Modify the attributes to use your backend as per your requirements.

P.S.: You can even add email validation and password strength.
